...
void InputHandler::fetchEvents()
{
	...
	{
		// SDL2 scaled mouse coordinates to the renderer logical size on its own,
		// SDL3 leaves them in window coordinates and expects this conversion.
		// Touch events are deliberately left alone - they stay normalized.
