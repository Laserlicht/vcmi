...
void ScreenHandler::initializeScreenBuffers()
{
	...
	SDL_RenderSetLogicalSize(mainRenderer, logicalSize.x*2, logicalSize.y*2);
	...
	screenTexture = SDL_CreateTexture(mainRenderer, SDL_PIXELFORMAT_ARGB8888, SDL_TEXTUREACCESS_STREAMING, logicalSize.x*2, logicalSize.y*2);
